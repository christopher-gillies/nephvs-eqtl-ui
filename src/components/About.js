  ...
  render() {
    return(
      ...
      <Card title="Data processing pipeline" size="col-lg">
        ...
        <p> <b>Alignment:</b> <a href="http://genome.sph.umich.edu/wiki/GotCloud">GotCloud: 1.12.3</a> (BWA 0.7.5a-r405) </p>
        <p> <b>Single nucleotide variants calling:</b> <a href="http://genome.sph.umich.edu/wiki/GotCloud">GotCloud: 1.12.3</a> </p>
        <p> <b>Indels:</b> <a href="https://software.broadinstitute.org/gatk/">GATK 2.8.1</a> UnifiedGenotyper following GATK Best Practices </p>
        <p> <b>Deletions:</b> <a href="http://software.broadinstitute.org/software/genomestrip/">GenomeSTRiP 1.04</a> </p>
        <p> <b>eQTL Mapping:</b>  <a href="https://www.ncbi.nlm.nih.gov/pubmed/22492648">Matrix eQTL</a> </p>
        <p>
        Eligible variants considered were those with an allele frequency (AF) &gt; 0.03 in the NEPTUNE cohort. Variants were considered to be in the cis region of those genes that had any nucleotide in a 1MB region centered on the variant (500kB flanking region). We adjusted for age, sex, <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3398141/">PEER</a> factors, and principal components. PEER factors were created utilizing the PEER framework as previously described, adjusting for patient age, sex, and microarray batch. We used 25 PEER factors in the TUB and 31 PEER factors in the GLOM.
        ...
        <p> <b>Fine Mapping:</b> <a href="https://projecteuclid.org/euclid.aoas/1475069621">TORUS</a> and <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4908152/"> DAP </a> </p>
      </Card>
